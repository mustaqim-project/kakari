...
use App\Http\Controllers\Admin\CatDownloadController;
use App\Http\Controllers\Admin\DownloadController;
use App\Http\Controllers\Admin\EkoranController;
use App\Http\Controllers\Admin\PendidikanController;
use App\Http\Controllers\Admin\PengurusController;
use App\Http\Controllers\Admin\PodcastPlaylistController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    /** Download Routes */
    Route::resource('download_cat', CatDownloadController::class);
    ...
    /** Podcast-playlist Routes */
    Route::resource('podcast-playlist', PodcastPlaylistController::class);
