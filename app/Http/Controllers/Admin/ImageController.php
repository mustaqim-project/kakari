...
class ImageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($relativeImagePath) {
            $baseUrl = 'https://image.ic-syekhburhanuddin.com/';
    ...
    public function update(Request $request, Image $image)
    {
        ...
        if ($request->hasFile('image')) {
            // Delete old image
            $oldPath = str_replace('https://image.ic-syekhburhanuddin.com/', '', $image->path);
    ...
    {
        // Delete image file
        $path = str_replace('https://image.ic-syekhburhanuddin.com/', '', $image->path);
