    ...
    <section class="section">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h4>{{ __('admin.Update Podcast Playlist') }}</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.podcast-playlist.update', $playlist->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('admin.podcast-playlist.index') }}" class="btn btn-secondary ml-2">{{ __('admin.Cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
