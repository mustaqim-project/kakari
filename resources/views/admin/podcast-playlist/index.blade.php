...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ __('admin.Podcast Playlist') }}</h1>
        </div>

        <div class="card card-primary">
            <div class="card-header">
                <h4>{{ __('admin.All Podcast Playlist') }}</h4>
                <div class="card-header-action">
                    <a href="{{ route('admin.podcast-playlist.create') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped" id="podcast-playlist-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($playlists as $playlist)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.podcast-playlist.edit', $playlist->id) }}"
                                            class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('admin.podcast-playlist.destroy', $playlist->id) }}" method="POST"
...
@push('scripts')
    <script>
        $("#podcast-playlist-table").DataTable({
            "columnDefs": [{
                "orderable": false,
