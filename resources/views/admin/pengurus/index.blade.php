    ...
    <section class="section">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h4>{{ __('admin.All Struktur Organisasi') }}</h4>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped" id="pengurus-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($penguruses as $pengurus)
                                <tr>
                                    ...
                                    <td>
                                        @if ($pengurus->image)
                                            <img src="{{ asset($pengurus->image) }}" alt="image" width="60">
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.pengurus.destroy', $pengurus->id) }}" method="POST"
