...
<head>
  ...
  <title>Login &mdash; ic-syekhburhanuddin</title>
  ...
  <link rel="stylesheet" href="{{ asset('admin/assets/modules/bootstrap-social/bootstrap-social.css') }}">
    <link rel="icon" href="https://ic-syekhburhanuddin.com/uploads/iNIS2R6SWIih4Ag3ceyXJnVaPZ3kBc.webp" type="image/png">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="simple-footer">
              {{ __('admin.Copyright') }} &copy; {{ __('ic-syekhburhanuddin 2023') }}
            </div>
          </div>
        </div>
      </div>
