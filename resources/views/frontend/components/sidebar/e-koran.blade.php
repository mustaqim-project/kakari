    ...
    <div class="card-body text-center p-0">
        ...
        <div class="modal fade" id="ekoranModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header border-0">
                        <h5 class="modal-title">{{ $latestEkoran->judul ?? 'E-Koran Terbaru' }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-0">
                        <div class="ratio ratio-1x1">
                            <iframe src="https://docs.google.com/viewer?url={{ urlencode($latestEkoran->url_pdf ?? 'https://example.com/sample.pdf') }}&embedded=true"
                                style="width: 100%; height: 70vh;" frameborder="0"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer border-0">
                        <a href="{{ $latestEkoran->url_pdf ?? '#' }}" class="btn btn-primary"><i class="fas fa-download me-2"></i>Download</a>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    </div>
                </div>
            </div>
