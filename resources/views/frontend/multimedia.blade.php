...
@section('content')
    ...
    <section class="py-5" id="multimedia">
        <div class="container">
                            ...
                            <div class="card h-100 border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="badge bg-light text-dark"><i class="fas fa-eye me-1"></i>
                                            {{ number_format(rand(1000, 20000)) }}</span>
                                        <span
                                            class="text-muted small">{{ rand(10, 60) }}:{{ str_pad(rand(0, 59), 2, '0', STR_PAD_LEFT) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <img src="assets{{ $podcast->cover_image }}" alt="Podcast Cover"
                                            class="rounded me-3" width="80" height="80">
                                        <div>
                                            <h5 class="card-title mb-1">{{ $podcast->title }}</h5>
                                            <p class="card-text small text-muted mb-2">
                                                {{ Str::limit($podcast->description, 70) }}</p>
                                            <span class="badge bg-light text-dark small"><i class="far fa-clock me-1"></i>
                                                {{ $podcast->formatted_duration }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        <a href="{{ $podcast->audio_url }}" download
                                            class="btn btn-sm btn-outline-primary"><i class="fas fa-download me-1"></i>
                                            Download</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="mb-5">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="h4"><i class="fas fa-book-open me-2 text-primary"></i> Infografis, E-Book & Komik Dakwah
                    </h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#" class="btn btn-sm btn-outline-primary"><i
                                                class="fas fa-download me-1"></i> {{ $download->download_file }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card bg-primary text-white py-5 border-0 shadow">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            <a href="#" class="btn btn-light"><i class="fab fa-youtube me-2"></i> Subscribe
                                YouTube</a>
                            <a href="#" class="btn btn-outline-light"><i class="fab fa-telegram me-2"></i> Join
                                Telegram</a>
                        </div>
                    </div>
                </div>
